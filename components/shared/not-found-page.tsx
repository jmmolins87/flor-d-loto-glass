  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#0f1117] text-white">
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-6 py-16 lg:justify-start lg:px-12 xl:px-20">
        <ScrollReveal
          className="w-full max-w-3xl rounded-[2rem] border border-white/20 bg-white/10 p-8 text-center shadow-[0_40px_120px_-55px_rgba(0,0,0,0.75)] backdrop-blur-xl md:p-12 lg:ml-0 lg:max-w-2xl lg:text-left"
          distance={36}
        >
